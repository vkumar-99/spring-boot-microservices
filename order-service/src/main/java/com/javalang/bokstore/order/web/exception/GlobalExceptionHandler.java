package com.javalang.bokstore.order.web.exception;

import com.javalang.bokstore.order.domain.InvalidOrderException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ProblemDetail handleInvalidOrderException(InvalidOrderException e) {
        ...
        problemDetail.setTitle("Invalid order items");
